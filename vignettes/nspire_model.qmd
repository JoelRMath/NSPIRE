...
graph TD
    ...
    %% Explicitly Style Nodes to prevent text wash-out
    ...
    %% Explicitly Style Links (Edges) to force black text
...
```{r}
#| label: tbl-scripts
#| tbl-cap: "NSPIRE Simulator R Scripts and Architecture Roles"
#| echo: false
#| message: false
#| warning: false
